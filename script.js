    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאור איטום גגות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e7ddd846-85ec-4c01-bb01-0ef3abec00df',
                    name: data.name || '',
                    email: data.email || '',
